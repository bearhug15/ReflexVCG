...
lemma
 ...
 and st13_if:"(\<not>(getVarBool st13 ''inp_1''))=True"
 ...
 and st14_if:"(getVarBool st14 ''inp_4'')=False"
 and st14_if:"(\<not>(getVarBool st14 ''inp_3''))=True"
 and st15:"(st15=(setVarBool st14 ''out_2'' False))"
