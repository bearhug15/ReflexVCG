...
lemma
 ...
 and st13_FridgeCompressorController_state:"(getPstate st13 ''FridgeCompressorController'')=''error''"
 and st13_FreezerCompressorController_state:"(getPstate st13 ''FreezerCompressorController'')=''checkTemp''"
 and st13_if:"(getVarBool st13 ''inp_4'')=False"
 and st13_if:"(\<not>(getVarBool st13 ''inp_3''))=True"
