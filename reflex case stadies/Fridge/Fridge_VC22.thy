...
lemma
 ...
 and st9_if:"(getVarBool st9 ''inp_5'')=True"
 and st10:"(st10=(setVarBool st9 ''out_3'' True))"
 and st11:"(st11=(setPstate st10 ''FridgrDoorController'' ''open''))"
 and st11_FridgeCompressorController_state:"(getPstate st11 ''FridgeCompressorController'')=''error''"
 and st11_FreezerCompressorController_state:"(getPstate st11 ''FreezerCompressorController'')=''checkTemp''"
 and st11_if:"(getVarBool st11 ''inp_4'')=False"
 and st11_if:"(\<not>(getVarBool st11 ''inp_3''))=True"
