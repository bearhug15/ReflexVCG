...
lemma
 ...
 and st8_FridgeCompressorController_state:"(getPstate st8 ''FridgeCompressorController'')=''error''"
 and st8_FreezerCompressorController_state:"(getPstate st8 ''FreezerCompressorController'')=''error''"
