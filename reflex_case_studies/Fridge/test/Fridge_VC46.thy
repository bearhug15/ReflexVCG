...
lemma
 ...
 and st9_if10:"((getVarBool st9 ''inp_5'') = False)=True"
 and st10:"(st10=(setVarBool st9 ''out_3'' False))"
 and st11:"(st11=(setPstate st10 ''FridgrDoorController'' ''closed''))"
 and st11_open_timeout:"30000>(ltime st11 ''FridgrDoorController'')"
 and st11_FridgeCompressorController_state:"(getPstate st11 ''FridgeCompressorController'')=''stop''"
 and st11_FreezerCompressorController_state:"(getPstate st11 ''FreezerCompressorController'')=''checkTemp''"
 and st11_if16:"(getVarBool st11 ''inp_4'')=False"
 and st11_if17:"(\<not>(getVarBool st11 ''inp_3''))=True"
 and st12:"(st12=(setVarBool st11 ''out_2'' False))"
