...
lemma
 ...
 and st9_open_timeout:"30000>(ltime st9 ''FridgrDoorController'')"
 and st9_FridgeCompressorController_state:"(getPstate st9 ''FridgeCompressorController'')=''checkTemp''"
 and st9_if12:"(getVarBool st9 ''inp_2'')=False"
 and st9_if13:"(\<not>(getVarBool st9 ''inp_1''))=True"
 ...
 and st10_if10:"(getVarBool st10 ''inp_4'')=False"
 and st10_if11:"(\<not>(getVarBool st10 ''inp_3''))=True"
 and st11:"(st11=(setVarBool st10 ''out_2'' False))"
