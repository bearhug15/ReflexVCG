...
lemma
 ...
 and st13_FridgeCompressorController_state:"(getPstate st13 ''FridgeCompressorController'')=''stop''"
 and st13_FreezerCompressorController_state:"(getPstate st13 ''FreezerCompressorController'')=''checkTemp''"
 and st13_if7:"(getVarBool st13 ''inp_4'')=False"
 and st13_if8:"(\<not>(getVarBool st13 ''inp_3''))=True"
 and st14:"(st14=(setVarBool st13 ''out_2'' False))"
