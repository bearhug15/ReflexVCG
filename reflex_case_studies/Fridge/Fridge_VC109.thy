...
lemma
 ...
 and st12_FridgeCompressorController_state:"(getPstate st12 ''FridgeCompressorController'')=''stop''"
 and st12_FreezerCompressorController_state:"(getPstate st12 ''FreezerCompressorController'')=''checkTemp''"
 and st12_if25:"(getVarBool st12 ''inp_4'')=False"
 and st12_if26:"(\<not>(getVarBool st12 ''inp_3''))=True"
