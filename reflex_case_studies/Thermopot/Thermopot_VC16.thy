...
lemma
 ...
 and st6_if3:"((getVarBool st6 ''boilingButton_0'') = True)=False"
 and st6_if5:"((getVarInt st6 ''temperature_0'') \<ge> (getVarInt st6 ''selectedTemp_0''))=False"
 and st6_if7:"((getVarInt st6 ''temperature_0'') < ((getVarInt st6 ''selectedTemp_0'') - 5))=False"
