...
lemma
 ...
 and st5_if14:"((getVarBool st5 ''boilingButton_0'') = True)=True"
 and st6:"(st6=(setVarBool st5 ''mods_0'' True))"
 and st7:"(st7=(setPstate st6 ''HeaterController'' ''heating''))"
