...
lemma
 ...
 and st8_HeaterController_state:"(getPstate st8 ''HeaterController'')=''maintaining''"
 and st8_if17:"((getVarBool st8 ''boilingButton_0'') = True)=False"
 and st8_if19:"((getVarInt st8 ''temperature_0'') \<ge> (getVarInt st8 ''selectedTemp_0''))=False"
 and st8_if21:"((getVarInt st8 ''temperature_0'') < ((getVarInt st8 ''selectedTemp_0'') - 5))=False"
