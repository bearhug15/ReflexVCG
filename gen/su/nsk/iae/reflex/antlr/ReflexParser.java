...
public class ReflexParser extends Parser {
	...
	public static final int
		...
		T__59=60, T__60=61, T__61=62, PORT_TYPE=63, BREAK=64, INFIX_POSTFIX_OP=65, 
		MUL_OP=66, SHIFT_OP=67, EQ_OP=68, BIT_AND_OP=69, BIT_XOR_OP=70, BIT_OR_OP=71, 
		AND_OP=72, OR_OP=73, COMP_OP=74, INTEGER=75, UNSIGNED_INTEGER=76, FLOAT=77, 
		DEC_FLOAT=78, HEX_FLOAT=79, DEC_SEQ=80, HEX_SEQ=81, BIN_EXPONENT=82, EXPONENT=83, 
		DECIMAL=84, OCTAL=85, HEX=86, HEX_PREFIX=87, LONG=88, FLOAT_SUFFIX=89, 
		UNSIGNED=90, TIME=91, DAY=92, HOUR=93, MINUTE=94, SECOND=95, MILISECOND=96, 
		BOOL_VAL=97, STRING=98, WS=99, ID=100;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "PORT_TYPE", "BREAK", "INFIX_POSTFIX_OP", "MUL_OP", 
			"SHIFT_OP", "EQ_OP", "BIT_AND_OP", "BIT_XOR_OP", "BIT_OR_OP", "AND_OP", 
			"OR_OP", "COMP_OP", "INTEGER", "UNSIGNED_INTEGER", "FLOAT", "DEC_FLOAT", 
			"HEX_FLOAT", "DEC_SEQ", "HEX_SEQ", "BIN_EXPONENT", "EXPONENT", "DECIMAL", 
			"OCTAL", "HEX", "HEX_PREFIX", "LONG", "FLOAT_SUFFIX", "UNSIGNED", "TIME", 
			"DAY", "HOUR", "MINUTE", "SECOND", "MILISECOND", "BOOL_VAL", "STRING", 
			"WS", "ID"
		};
	}
	...
	public final StatementSeqContext statementSeq() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1043564069264L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 38721819649L) != 0)) {
				{
				{
				setState(301);
